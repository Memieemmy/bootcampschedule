...
export function DayColumn({
  ...
  // ── Droppable: column นี้รับการ์ดที่ลากมาได้ ─────────────────────────────
...
function HolidayDisplay({ onClear }) {
  return (
    <div style={{ textAlign:"center", padding:"20px 8px" }}>
      ...
      <button onClick={onClear} style={{ padding:"4px 14px", borderRadius:7, border:"1px solid #D1D5DB", background:"#fff", color:"#6B7280", fontSize:10, fontWeight:500, cursor:"pointer" }}>
        🔓 Edit
      </button>
    </div>
  );
